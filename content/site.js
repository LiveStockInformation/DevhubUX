...
const data = {
  app: {
    portalName: 'Livestock Developer Hub'
  },
  heading: {
    menu: 'Menu',
  ...
  cookieBanner: {
    body: 'Livestock Developer Hub uses cookies to make the site simpler.',
    link: 'Find out more about cookies'
  },
  phasebanner: {
    phase: 'Test',
    body: `The Sheep Service went live 28th March 2022, Cattle Service coming soon.`
  },
  authWarning: {
    title: 'Warning',
    content: [
      {
        Type: 'DIV',
        Body: `<a href='/auth/register' class='ls-button'>Create an account</a><p class='ls-body'>or <a href='/auth/login' class='ls-link ls-!-margin-left-1'><strong>sign in</strong></a> to the Livestock Developer Hub.</p>`
      }
    ]
  },
  support: {
    ...
    content: [
      {
        Type: 'DIV',
        Body: "<p class='ls-body'>If you wish to create an account to be able to connect to our services, would like to register your application so you can test it,  or you have a problem or query relating to our services, please email <a href='mailto:devsupport@livestockinformation.org.uk'>devsupport@livestockinformation.org.uk</a> Our support team will get back to you within 2 working days.</p>"
      }
    ]
  },
  'support-submitted': {
    ...
    content: [
      ...
      {
        Type: 'P',
        Body: "Continue to the <a href='/' class='ls-link'>home page</a>."
      }
    ]
  },
  profile: {
  ...
  cookies: {
    ...
    content: [
      {
        Type: 'P',
        Body: "The Livestock Developer Hub puts small files (known as 'cookies') onto your computer to collect information about how you browse the site. Find out more about the cookies we use, what they're for and when they expire."
      },
      {
        Type: 'H2',
  ...
  privacy: {
    ...
    content: [
      {
        Type: 'P',
        Body: "This privacy policy relates to the information we store about you as a Developer Hub user. It does not relate to the privacy of the end users of any application you develop; under our <a href='/terms-and-conditions' class='ls-link'>terms of use</a> you are responsible for the information stored by your application."
      },
      {
        Type: 'P',
      ...
      },
      {
        ...
        Body: [
          ...
          "your IP address, and details of which version of <a href='https://www.gov.uk/help/browsers' class='ls-link'>web browser</a> you use",
          "information on how you use our site, based on <a href='/cookies' class='ls-link'>cookies</a> and page tagging techniques",
      ...
      {
        Type: 'P',
        Body: "If you want us to delete all the information we hold about you, email our <a href='/support' class='ls-link'>support team</a>."
      },
      {
        Type: 'H2',
      ...
      },
      {
        Type: 'UL',
        Body: [
          "email our <a href='/support' class='ls-link'>support team</a> to find out which livestock office to contact",
  ...
  'terms-and-conditions': {
    ...
    content: [
      ...
      {
        Type: 'P',
        Body: "Read this disclaimer in conjunction with our <a href='/privacy-policy' class='ls-link'>privacy policy</a>."
      },
      {
        Type: 'P',
        Body: 'The Livestock Information Developer Hub website and material relating to government information, products and services (or to third party information, products and services) is provided ‘as is’.'
      },
      {
        Type: 'P',
      ...
      {
        Type: 'P',
        Body: "The material featured on this site is subject to crown copyright, third party copyright or both. For more details, read our <a href='https://www.nationalarchives.gov.uk/information-management/re-using-public-sector-information/uk-government-licensing-framework/crown-copyright/' class='ls-link' target='_blank'>copyright notice (opens in a new tab)</a>."
      },
      {
        Type: 'P',
        Body: 'The names, images and logos identifying livestock are our proprietary marks. You are not allowed to copy our logos or any third party logos accessed through this site unless you have prior approval from the copyright owner.'
      },
      {
        Type: 'P',
      ...
      {
        Type: 'P',
        Body: "Our <a href='/privacy-policy' class='ls-link'>privacy policy</a> explains how we protect and respect the data we collect from you. When you use this site, you accept this policy."
      },
      {
        Type: 'H2',
        Body: 'Governing law'
  ...
  'accessibility-statement': {
    ...
    content: [
      {
        Type: 'P',
        Body: 'This page only contains information about the Livestock Developer Hub service, available at <a href="https://developers.livestockinformation.org.uk/" target="blank">https://developers.livestockinformation.org.uk/</a>.'
      },
      {
        Type: 'H3',
      ...
      {
        Type: 'P',
        Body: 'This website is run by the Livestock Developer Hub. We want as many people as possible to be able to use this website. For example, that means you should be able to:'
      },
      {
        Type: 'UL',
        Body: [
      ...
      {
        Type: 'P',
        Body: '<a class="ls-link" href="https://mcmw.abilitynet.org.uk/">AbilityNet</a> has advice on making your device easier to use if you have a disability.'
      },
      {
        Type: 'H3',
      ...
      {
        Type: 'P',
        Body: 'If you have difficulty using this service, contact us by using our <a class="ls-link" href="/support">support page</a>.'
      },
      {
        Type: 'P',
        Body: 'If you need any part of this service in a different format like large print, audio recording or braille, contact us by using our <a class="ls-link" href="/support">support page</a>.'
      },
      {
        Type: 'P',
      ...
      {
        Type: 'P',
        Body: 'We’re always looking to improve the accessibility of this website. If you find any problems not listed on this page or think we’re not meeting accessibility requirements, contact us via our <a class="ls-link" href="/support">support page</a>.'
      },
      {
        Type: 'H3',
      ...
      {
        Type: 'P',
        Body: 'The Equality and Human Rights Commission (EHRC) is responsible for enforcing the Public Sector Bodies (Websites and Mobile Applications) (No. 2) Accessibility Regulations 2018 (the ‘accessibility regulations’). If you’re not happy with how we respond to your complaint, <a class="ls-link" href="https://www.equalityadvisoryservice.com">contact the Equality Advisory and Support Service (EASS)</a>.'
      },
      {
        Type: 'H3',
      ...
      {
        Type: 'P',
        Body: 'Livestock Information Limited is committed to making its website accessible, in accordance with the Public Sector Bodies (Websites and Mobile Applications) (No. 2) Accessibility Regulations 2018.'
      },
      {
        Type: 'H3',
      ...
      {
        Type: 'P',
        Body: 'This website is partially compliant with the <a class="ls-link" href="https://www.w3.org/TR/WCAG21/">Web Content Accessibility Guidelines version 2.1</a> AA standard, due to the non-compliances listed below.'
      },
      {
        Type: 'H3',
      ...
      {
        Type: 'INSET',
        Body: 'This statement was prepared on 3 February 2021. It was last reviewed on 3 February 2021. This website was last tested on 26 September 2022. The test was carried out by the Livestock Developer Hub.'
      }
    ]
  },
  'logged-out': {
    ...
    url: '/',
    sessionUrl: '/auth/login',
    sessionContent: [
      {
        Type: 'DIV',
        Body: "<p class='ls-body m--b-xlarge'>Sorry, you will need to sign back in.  </p>"
      }
    ],
    content: [
      {
        Type: 'DIV',
        Body: "<p class='ls-body m--b-xlarge'> Thank you for visiting the Livestock Information Developer hub.</p>"
      }
    ],
    buttons: {
  ...
  'password-changed': {
    ...
    content: [
      {
        Type: 'P',
        Body: `<a href='/auth/login' class='ls-link'>Sign in</a> to the Developer Hub with your new password.`
      }
    ]
  },
  404: {
    ...
    content: [
      ...
      {
        Type: 'P',
        Body: `<a href='/' class='ls-link'>Go back to the homepage</a>`
      }
    ]
  },
  500: {
    ...
    content: [
      ...
      {
        Type: 'P',
        Body: `<a href='/support' class='ls-link'>Contact us</a> if you are having issues with the Developer Hub.`
      }
    ]
  }
}
